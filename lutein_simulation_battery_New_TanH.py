...
arr_tempA=np.column_stack((normalizer(arr_temp[:,0]),normalizer(arr_temp[:,1]),normalizer(arr_temp[:,2]),normalizer(arr_temp[:,3]),normalizer(arr_temp[:,4]),normalizer(arr_temp[:,5])))
...
network_2=NetworkReader.readFrom(net_fold+ 'network_Type2H1New_LessNoise.xml')
network_4=NetworkReader.readFrom(net_fold+ 'network_Type2H2New_LessNoise.xml')
...
arr_valT2=np.column_stack((normalizer(standardizer(arr_val[:,0])),normalizer(standardizer(arr_val[:,1])),normalizer(standardizer(arr_val[:,2])),normalizer(standardizer(arr_val[:,3])),normalizer(standardizer(arr_val[:,4])),normalizer(standardizer(arr_val[:,5]))))
...
sim_deNorm2=np.column_stack((de_normalizer(sim_net2[:,0],theta_Val[:,0]),de_normalizer(sim_net2[:,1],theta_Val[:,1]),de_normalizer(sim_net2[:,2],theta_Val[:,2]),de_normalizer(sim_net2[:,3],theta_Val[:,3]),de_normalizer(sim_net2[:,4],theta_Val[:,4])))
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_ExpTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_ExpTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
#denormalize and rescale to real size
sim_deNorm4=np.column_stack((de_normalizer(sim_net4[:,0],theta_Val[:,0]),de_normalizer(sim_net4[:,1],theta_Val[:,1]),de_normalizer(sim_net4[:,2],theta_Val[:,2]),de_normalizer(sim_net4[:,3],theta_Val[:,3]),de_normalizer(sim_net4[:,4],theta_Val[:,4])))
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_ExpTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_ExpTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp2a],axis=1,keys=['Experimental','Simulated'])     
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_SimTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_SimTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp4a],axis=1,keys=['Experimental','Simulated'])   
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_SimTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_SimTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
