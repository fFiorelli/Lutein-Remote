...
for noise in noise_list:
    ...
    enh_array=np.column_stack((standardizer(enh_array[1:,0]),standardizer(enh_array[1:,1]),standardizer(enh_array[1:,2]),standardizer(enh_array[1:,3]),standardizer(enh_array[1:,4])))
