...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_ExpTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_ExpTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_ExpTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_ExpTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp2a],axis=1,keys=['Experimental','Simulated'])     
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_SimTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_SimTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp4a],axis=1,keys=['Experimental','Simulated'])   
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_SimTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_SimTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
