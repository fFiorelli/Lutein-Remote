...
network_2=NetworkReader.readFrom(net_fold+ 'network_Type2H1NewSTD_LessNoise.xml')
network_4=NetworkReader.readFrom(net_fold+ 'network_Type2H2NewSTD_LessNoise.xml')
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_ExpTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_ExpTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_ExpTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_ExpTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp2a],axis=1,keys=['Experimental','Simulated'])     
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_SimTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_LessNoise_SimTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp4a],axis=1,keys=['Experimental','Simulated'])   
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_SimTrajSTD.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_LessNoise_SimTrajSTD_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
