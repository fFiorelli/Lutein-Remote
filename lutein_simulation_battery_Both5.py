...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossVal_Both_ExpTraj2.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossVal_Both_ExpTraj_Rescale2.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_val,columns=lista_col2)
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossVal_Both_ExpTraj2.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossVal_Both_ExpTraj_Rescale2.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_val,columns=lista_col2)
...
theta=pd.concat([theta,temp2a],axis=1,keys=['Experimental','Simulated'])     
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossVal_Both_SimTraj2.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossVal_Both_SimTraj_Rescale2.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_val,columns=lista_col2)
...
theta=pd.concat([theta,temp4a],axis=1,keys=['Experimental','Simulated'])   
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossVal_Both_SimTraj2.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossVal_Both_SimTraj_Rescale2.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_val,columns=lista_col2)
