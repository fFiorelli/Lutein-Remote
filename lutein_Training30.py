...
for noise in noise_list:
    ...
    for i,m in product([0,1,3],xrange(30)):
        #i is the dataset
    ...
    NetworkWriter.writeToFile(net1,net_fold+ 'network_Type1H130sets.xml')
    trainer2 = BackpropTrainer(net2, ds2, verbose = True)
    trainer2.trainEpochs(nEpochs)
    NetworkWriter.writeToFile(net2,net_fold+ 'network_Type2H130sets.xml')
    trainer3 = BackpropTrainer(net3, ds1, verbose = True)
    trainer3.trainEpochs(nEpochs)
    NetworkWriter.writeToFile(net3,net_fold+ 'network_Type1H230sets.xml')
    trainer4 = BackpropTrainer(net4, ds2, verbose = True)
    trainer4.trainEpochs(nEpochs)
    NetworkWriter.writeToFile(net4,net_fold+ 'network_Type2H230sets.xml')
