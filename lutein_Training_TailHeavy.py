...
tail_lengths=((6,12),(18,24),(30,36),(42,48),(54,60))
...
for noise in noise_list:
    ...
    #Produce Top Heavy list by repeating the "ends"
    for i,m in product(tail_lengths,xrange(10)):
        #i is the dataset
        #for each dataset we produce a 100 noise_arrays
        temp_data=arr_test[i[0]:i[1]]
        #generate an array the size of the current sub array, to be added.
...
ds2 = SupervisedDataSet(5, 3)
    #this is meant to 
r_lengths1=[[i,i+12] for i in xrange(0,12*100*5 ,12)]
r_lengths2=[[i,i+12] for i in xrange(12*100*5,12*100*5+12*10*5,6)]
    #print r_lengths[-1]
    #print len(enh_array)
...
NetworkWriter.writeToFile(net2,net_fold+ 'network_Type2H1_Tail.xml')
trainer4 = BackpropTrainer(net4, ds2, verbose = True)
trainer4.trainEpochs(nEpochs)
NetworkWriter.writeToFile(net4,net_fold+ 'network_Type2H2_Tail.xml')
