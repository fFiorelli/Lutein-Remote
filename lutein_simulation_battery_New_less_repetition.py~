...
network_2=NetworkReader.readFrom(net_fold+ 'network_Type2H1New_less.xml')
network_4=NetworkReader.readFrom(net_fold+ 'network_Type2H2New_less.xml')
...
#Use arr_val
arr_valT2=np.column_stack((normalizer(arr_val[:,0]),normalizer(arr_val[:,1]),normalizer(arr_val[:,2]),normalizer(arr_val[:,3]),normalizer(arr_val[:,4]),normalizer(arr_val[:,5])))
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_less_ExpTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_less_ExpTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
...
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_less_ExpTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_less_ExpTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
...
theta=pd.concat([theta,temp2a],axis=1,keys=['Experimental','Simulated'])     
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_less_SimTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H1_CrossValNew_less_SimTraj_Rescale.csv')
#overwrite
...
theta=pd.concat([theta,temp4a],axis=1,keys=['Experimental','Simulated'])   
#save
beta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_less_SimTraj.csv')
theta.to_csv(save_fold+'Lutein_NN_Type2H2_CrossValNew_less_SimTraj_Rescale.csv')
#overwrite
beta=pd.DataFrame(arr_valT2,columns=lista_col2)
beta.drop('Time',axis=1, inplace=True)
theta=pd.DataFrame(arr_temp[len(arr_test):],columns=lista_col2)
