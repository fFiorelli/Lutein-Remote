...
theta=pd.DataFrame(arr_temp,columns=lista_col2)
...
sim_net2[:,0]
,de_standardizer(de_normalizer(sim_net2[:,1],standardizer(iota[:,1])),iota[:,1])
,de_standardizer(de_normalizer(sim_net2[:,2],standardizer(iota[:,2])),iota[:,2])
,de_standardizer(de_normalizer(sim_net2[:,3],standardizer(iota[:,3])),iota[:,3])
,de_standardizer(de_normalizer(sim_net2[:,4],standardizer(iota[:,4])),iota[:,4])))
...
sim_net4[:,0]
,de_standardizer(de_normalizer(sim_net4[:,1],standardizer(iota[:,1])),iota[:,1])
,de_standardizer(de_normalizer(sim_net4[:,2],standardizer(iota[:,2])),iota[:,2])
,de_standardizer(de_normalizer(sim_net4[:,3],standardizer(iota[:,3])),iota[:,3])
,de_standardizer(de_normalizer(sim_net4[:,4],standardizer(iota[:,4])),iota[:,4])))
