...
sim_net2[:sLht,0]
,de_standardizer(de_normalizer(sim_net2[:sLht,1],standardizer(arr_temp[:sLht,1])),arr_temp[:sLht,1])
,de_standardizer(de_normalizer(sim_net2[:sLht,2],standardizer(arr_temp[:sLht,2])),arr_temp[:sLht,2])
,de_standardizer(de_normalizer(sim_net2[:sLht,3],standardizer(arr_temp[:sLht,3])),arr_temp[:sLht,3])
,de_standardizer(de_normalizer(sim_net2[:sLht,4],standardizer(arr_temp[:sLht,4])),arr_temp[:sLht,4])))
...
sim_deNorm2=np.concatenate((dataSet1,dataSet2),axis=0)
...
dataSet1=np.column_stack((
sim_net4[:sLht,0]
,de_standardizer(de_normalizer(sim_net4[:sLht,1],standardizer(arr_temp[:sLht,1])),arr_temp[:sLht,1])
,de_standardizer(de_normalizer(sim_net4[:sLht,2],standardizer(arr_temp[:sLht,2])),arr_temp[:sLht,2])
,de_standardizer(de_normalizer(sim_net4[:sLht,3],standardizer(arr_temp[:sLht,3])),arr_temp[:sLht,3])
,de_standardizer(de_normalizer(sim_net4[:sLht,4],standardizer(arr_temp[:sLht,4])),arr_temp[:sLht,4])))
dataSet2=np.column_stack((
sim_net4[sLht:,0]
,de_standardizer(de_normalizer(sim_net4[sLht:,1],standardizer(arr_temp[sLht:,1])),arr_temp[sLht:,1])
,de_standardizer(de_normalizer(sim_net4[sLht:,2],standardizer(arr_temp[sLht:,2])),arr_temp[sLht:,2])
...
sim_deNorm4=np.concatenate((dataSet1,dataSet2),axis=0)
