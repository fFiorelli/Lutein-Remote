...
NetworkWriter.writeToFile(net2,net_fold+ 'network_Type2H1NewSTD_LessNoise2.xml')
trainer4 = BackpropTrainer(net4, ds2, verbose = True)
trainer4.trainEpochs(nEpochs)
NetworkWriter.writeToFile(net4,net_fold+ 'network_Type2H2NewSTD_LessNoise2.xml')
